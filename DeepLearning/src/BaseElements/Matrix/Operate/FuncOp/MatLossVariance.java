...
import BaseElements.Scalar.Operate.ForMatOp.FuncForMatLossVariance;

public class MatLossVariance extends MatOperate {
	public MatLossVariance() {
		this.paramNum = 2;
	}
	@Override
	protected void method(Matrix caller, Matrix... matrixs) throws Exception {
		...
		caller.get(0, 0).link(new FuncForMatLossVariance(), scalars);
	}
}
